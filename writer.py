...
def enhance_user_data(raw_data: dict, github_profile_readme: str, domain: str = "General", feedback_issues: list = None, original_data: dict = None) -> dict:
    ...
    5. SENIORITY CALIBRATION (strict):
       - <2 yrs experience -> "Motivated", "Aspiring", "Results-driven", "Junior", "Developing"
       - 2-5 yrs experience -> "Experienced", "Skilled", "Proficient"  
       - 5+ yrs -> "Senior", "Lead", "Expert"
    6. PROFILE FORMULA: [Seniority-appropriate adjective] [Actual degree/role] specializing in [top 2 skills from Truth Data]. [One factual sentence from their actual experience].
